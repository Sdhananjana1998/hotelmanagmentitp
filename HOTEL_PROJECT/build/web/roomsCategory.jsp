                        ...
                        <div class="card-content">
                            <div class="container">
                                <form action="/action_page.php">
                                    <div class="row">
                                        <div class="col-25">
                                            <label for="room_typef">Enter Room Type</label>
                                        </div>
                                        <div class="col-75">
                                            <input type="text" id="room_typef" name="room_typef" placeholder="Enter Room Type..">
                                        </div>   
                                    </div>

                                    <div class="row">
                                        <div class="col-25">
                                            <label for="room_type_image">Select image:</label>
                                        </div>
                                        <div class="col-75">
                                            <input type="file" id="room_type_image" name="room_type_image" accept="image/*">
                                        </div>   
                                    </div>
                            ...
                            <table id="customers">
                                ...
                                <tr>
                                    ...
                                    <td><button class="buttonEdit">Edit</button>
                                        <button class="buttonDelete">Delete</button></td>
                                </tr>
                            </table>
