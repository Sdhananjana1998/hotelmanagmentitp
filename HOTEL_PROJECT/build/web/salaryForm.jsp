...
<%
    if (request.getParameter("submit") != null) {
        ...
        pst = conn.prepareStatement("insert into sal_details_form (emp_Id,emp_Name,emp_Designation,emp_Bsic_Sal,emp_ETF) values (?,?,?,?,?)");
                            ...
                            <div class="container">
                                <form  method="POST" action="#">  
                                    <div class="row">
                                        ...
                                        <div class="col-75">
                                            <input type="number" name="emp_Id" id="emp_Id"  placeholder="Enter Employee Id.." required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-25">
                                        ...
                                        <div class="col-75">
                                            <input type="text" name="emp_Name" id="emp_Name"  placeholder="Enter Emoplyee Name" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-25">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-75">
                                            <input type="number" name="emp_Bsic_Sal" id="emp_Bsic_Sal"  placeholder="Enter Basic Salary" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-25">
                                        ...
                                        <div class="col-75">
                                            <input type="number" name="emp_ETF" id="emp_ETF"  placeholder="Enter EPF Amount" required>
                                        </div>
                                    </div>
