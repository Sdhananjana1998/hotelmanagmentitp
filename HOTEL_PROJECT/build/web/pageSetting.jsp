...
<%
    if (request.getParameter("submit") != null) {
        String slider_image = request.getParameter("slider_image");
        ...
        pst = conn.prepareStatement("insert into room_resevation_page_slider (slider_image) values (?)");

        pst.setString(1, slider_image);
					...
					<div class="card-content">
						<div class="container">
						  ...
						  <form method="POST" action="#">
						   ...
						   <div class="row">
						    <div class="col-25">
						      <label for="slider_image">Select image:</label>
						    </div>
						    <div class="col-75">
						      <input type="file" id="slider_image" name="slider_image" accept="image/*">
                                                  ...
                                                  <button type="submit"  id="submit" name="submit" value="submit" class="button button3">Add New Slide Image</button>
		...
		<div class="wrapper">
			...
			<div class="col-12 col-m-12 col-sm-12">
				<div class="card">
						  ...
						  <img src="assets/5.jpg" alt="Flowers in Chania" width="1230" height="500">
						</div>
