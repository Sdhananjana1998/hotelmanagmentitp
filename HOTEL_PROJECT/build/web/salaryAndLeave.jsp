            ...
            <div class="row">
                <div  class="col-3 col-m-6 col-sm-6">
                    ...
                    <div  class="counter bg-primary">
                        <p><a href="salaryForm.jsp" style="color:#FFFFFF">
                ...
                <div class="col-3 col-m-6 col-sm-6">
                    <div class="counter bg-danger">
                        <a href="slaryReport.jsp" style="color:#FFFFFF">
                            <p>
                                <i class="fa fa-money"></i>
                            </p>
                            <h3>100+</h3>
                ...
                <div class="col-3 col-m-6 col-sm-6">
                    <div class="counter bg-success">
                        <a href="leaveForm.jsp" style="color:#FFFFFF">
                            <p>
                ...
                <div class="col-3 col-m-6 col-sm-6">
                    <div class="counter bg-danger">
                        <a href="leaveDetails.jsp" style="color:#FFFFFF">
                            <p>
                                <i class="fa fa-level-down"></i>
                            </p>
                            <h3>100+</h3>
