			...
			<div class="col-12 col-m-12 col-sm-12">
				<div class="card">
					<div class="card-header">
						<h3>
						  Select Year And Month To See The Salary Details
						</h3>
					</div>
					<div class="card-content">
						  <form action="/action_page.php">
						    <div class="row">
						    <div class="col-25">
						      <label for="lname">Select Year And Month:</label>
						    </div>
						    <div class="col-75">
						      <input type="month" id="date_To" name="Date_To">
						    </div>
						  </div>
						  <button class="button button3"> OK</button>
						  </form>
						</div>
