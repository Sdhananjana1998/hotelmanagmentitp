		...
		<div class="row">
			<div  class="col-3 col-m-6 col-sm-6">
				...
				<div  class="counter bg-primary">
					<p><a href="booked.jsp" style="color:#FFFFFF">
			...
			<div class="col-3 col-m-6 col-sm-6">
				<div class="counter bg-warning">
					<a href="rooms.jsp" style="color:#FFFFFF">
					<p>
						<i class="fa fa-bed" ></i>
					</p>
					<h3>100+</h3>
			...
			<div class="col-3 col-m-6 col-sm-6">
				<div class="counter bg-success">
					<a href="checkIn.jsp" style="color:#FFFFFF">
					<p>
			...
			<div class="col-3 col-m-6 col-sm-6">
				<div class="counter bg-danger">
					<a href="checkOut.jsp" style="color:#FFFFFF">
					<p>
			...
			<div class="col-3 col-m-6 col-sm-6">
				<div class="counter bg-danger">
					<a href="roomsCategory.jsp" style="color:#FFFFFF">
					<p>
					...
					<p>Rooms Category</p>
                        ...
                        <div class="col-3 col-m-6 col-sm-6">
				<div class="counter bg-success">
					<a href="add_New_Room.jsp" style="color:#FFFFFF">
					<p>
						<i class="fa fa-list-alt"></i>
					</p>
					<h3>100+</h3>
					<p>Add New Room</p>
                         ...
                         <div class="col-3 col-m-6 col-sm-6">
				<div class="counter bg-warning">
					<a href="new_booking_ad.jsp" style="color:#FFFFFF">
					<p>
						<i class="fa fa-list-alt"></i>
					</p>
					<h3>100+</h3>
			...
			<div class="col-3 col-m-6 col-sm-6">
				<div class="counter bg-primary">
					<a href="pageSetting.jsp" style="color:#FFFFFF">
					<p>
