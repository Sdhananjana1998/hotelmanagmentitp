				...
				<div class="card">
					...
					<table id="customers">
						  <tr>
						    ...
						    <th>Action</th>
                                                      ...
                                                      <%
                                                           ...
                                                           String query = "select * from sal_details_form";
						  ...
						  <tr>
						    ...
						    <td><%=rs.getString("emp_Bsic_Sal")%></td>
						    <td><%=rs.getString("emp_ETF")%></td>
						    <td>
                                                        <a href="up_salary_details.jsp?id=<%=id%>" class="buttonEdit">Edit</a>
                                                        <td><a href="del_salary_details.jsp?id=<%=id%>" class="buttonDelete">Delete</a></td>
