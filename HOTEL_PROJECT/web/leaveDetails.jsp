				...
				<div class="card">
					...
					<table id="customers">
						  <tr>
						    ...
						    <th>Action</th>
                                                  ...
                                                  <%
                                                           ...
                                                           String query = "select * from leave_details_form";
						  ...
						  <tr>
						    ...
						    <td><a href="up_leave_details.jsp?id=<%=id%>" class="buttonEdit">Edit</a>
                                                        <td><a href="del_leave_details.jsp?id=<%=id%>" class="buttonDelete">Delete</a></td>
						  </tr>
